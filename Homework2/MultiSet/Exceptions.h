...
namespace Exceptions {
	...
	constexpr char BAD_ALLOC_EXCEPTION[] = "Error! Memory cannot be allocated for storage!";
	...
	constexpr char CLOSED_FILE_EXCEPTION[] = "Error! Cannot open file for reading/writing!";
}
